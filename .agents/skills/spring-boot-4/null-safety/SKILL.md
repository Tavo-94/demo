...
- Agent forgets `package-info.java` - without `@NullMarked`, most checks remain unknown. Note: Java package annotations do NOT cascade. You must create a `package-info.java` file in every single subpackage directory.
